        ...
        <div className="max-w-7xl mx-auto px-4 py-16 w-full">
          ...
          <div className="flex items-stretch justify-center space-x-8">
            {plans.map((plan, index) => (
              <div
              key={plan.name}
              className="w-80 relative group transform will-change-transform transition-transform ease-in-out duration-300 hover:scale-105"
            ...
            >
                ...
                <div className={`bg-neutral-900 rounded-2xl shadow-lg p-8 h-full flex flex-col min-h-[600px] transition-shadow duration-200 ease-out hover:shadow-2xl ${
