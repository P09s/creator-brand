...
const CREATOR_SECTIONS = [
  ...
  },
  {
    ...
    steps: [
      ...
      'To get a Verified badge on your stats, email verify@linkfluence.in with a screenshot of your analytics',
    ],
  },
];
        ...
        >
          ...
          <div className="flex items-center justify-between px-6 pt-5 pb-4 border-b border-gray-800">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h2 className="text-white font-semibold">How LinkFluence works</h2>
          ...
          <div className="px-6 py-5 space-y-3">
            ...
            <div className="bg-blue-500/5 border border-blue-500/20 rounded-xl p-4 mt-4">
              ...
              <p className="text-gray-400 text-xs leading-relaxed">
                Email us at <span className="text-white">support@linkfluence.in</span> — we typically respond within 4 hours.
              </p>
            </div>
          </div>
        </motion.div>
